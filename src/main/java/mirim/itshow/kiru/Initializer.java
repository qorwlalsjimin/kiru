...
//                        .brand("블랑수블랑").build(),
                ...
                Item.builder()
                        ...
                        .imageUrl(new String[]{"https://i.postimg.cc/5Nx0Ncrt/image.png", "https://www.trunkshow.co.kr/data/goods/367/2021/05/23443_temp_16216877067976view.jpg", "https://www.trunkshow.co.kr/data/goods/367/2021/05/23443_temp_16216877081920view.jpg"})
                        .color(new String[]{"흑색"})
                        .size(new String[]{"225", "230", "235", "240", "245", "250", "255"})
                ...
                Item.builder()
                        ...
                        .imageUrl(new String[]{"https://i.postimg.cc/ydm1snX9/image.png", "https://shop-phinf.pstatic.net/20200907_286/1599451978069oLBRr_JPEG/36811812568936998_1411221738.jpg?type=m510", "https://shop-phinf.pstatic.net/20200907_251/1599451501793FMuUt_JPEG/36811336323674262_1642490479.jpg?type=m510"})
                        .color(new String[]{"녹색", "청색", "분홍"})
                        .size(new String[]{"225", "230", "235", "240", "245", "250", "255"})
                        .categoryId(categoryRepository.findById(132L).orElse(null))
                        .country(Country.hanbok)
                        .brand("리우앤비우").build(),
                ...
                Item.builder()
                        .name("스텔라 실버")
                        .price(25000)
                        .description("당혜의 앞코와 메리제인 슈즈의 스트랩. 눈부시게 폭발하여 새로운 생명을 탄생시키는 별(STELLA)")
                        .imageUrl(new String[]{"https://trunkshow.co.kr/data/goods/367/2020/06/19960_tmp_bd9994b306d1d2cf9911f7d4c044f8fa7911view.jpg", "https://trunkshow.co.kr/data/goods/367/2020/06/19960_tmp_664a4a59feb53bab752b9a9ad62e44c67743view.jpg", "https://trunkshow.co.kr/data/goods/367/2020/06/19960_tmp_1b2849df9283b2b8f8dccfdfc6330edc3550view.jpg"})
                        .color(new String[]{"회색"})
                        .size(new String[]{"225", "230", "235", "240", "245", "250", "255"})
                        .categoryId(categoryRepository.findById(132L).orElse(null))
                        .country(Country.hanbok)
...
// 일본 - 유카타
                ...
                Item.builder()
                        .name("매화꽃")
                        .price(57900)
                        .description("녹차색과 황갈이 섞여 동양미가 은은하게 담긴 패턴의 유카타입니다.")
