...
export const TotalCart = ({ total, setTotal, cart, found, startDate, endDate, length, totalPrice }) => {
      ...
      <div className="total">
        <div className="totalfont">
          <div className="totalcount">
            <p className="cart_product_total_price">총 수량 {length}개</p>
          </div>
          ...
          <div className="payment">
            {/* 총 대여료 */}
            {/* total을 변환된 가격으로 출력 */}
            <p>총 대여료 <span className="cart_prouct_payment"> {Util.convertPrice(totalPrice)}</span>원</p>
          </div>
        </div>
      </div>
    </>
