...
export const Mainscreen = () => {
  ...
  useEffect(() => {
    ...
    gsap.set(revealElement2, { transformOrigin: "top", y: "890px", opacity: 0 });
  ...
  useEffect(() => {
    ...
    gsap.set(revealElement3, { transformOrigin: "top", y: "1700px", x: "50px", opacity: 0 });
    ...
    <div>
      ...
      <section className="page_2 panner " id='panner'>
        ...
        <div className="scroll__container">
          {showButton && (
            <button id="top" onClick={scrollToTop} className={`back-to-top ${showButton ? 'visible' : ''}`}


            >
              <p style={{ fontFamily: 'lostgun Regular' }}>Top</p>
            </button>
          )}
        </div>
        ...
        <div className="bobar">
          <img className='Vector' src="images/Vector154.svg" alt="" />
         ...
         <div className="showkimono">
          ...
          <div className="image-container">
            <img src="/images/Frame8.png"className='wa7' data-value={5} alt="" />
              ...
              <img src="/images/Frame5.png" className='wa'data-value={4} alt="" />
              <img src="/images/Frame6.png" className='wa'data-value={4} alt="" />
              <img src="/images/Frame7.png" className='wa'data-value={4} alt="" />
              <img src="/images/Frame8.png" className='w'data-value={4} alt="" />
              <img src="/images/Frame1.png" className='w'data-value={4} alt="" />
              <img src="/images/Frame2.png" className='w'data-value={4} alt="" />
              <img src="/images/Frame3.png" className='w'data-value={4} alt="" />
              <img src="/images/Frame4.png" className=''data-value={4} alt="" />
              <img src="/images/Frame5.png" className=''data-value={4} alt="" />
              <img src="/images/Frame7.png" className=''data-value={4} alt="" />
              <img src="/images/Frame8.png" className=''data-value={4} alt="" />
              <img src="/images/Frame9.png" className=''data-value={4} alt="" />
              <img src="/images/Frame10.png" className=''data-value={4} alt="" />
              <img src="/images/Frame3.png" className=''data-value={4} alt="" />
              <img src="/images/Frame3.png" className=''data-value={4} alt="" />
            </div>
