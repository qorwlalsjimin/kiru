package mirim.itshow.kiru.security;

import lombok.RequiredArgsConstructor;
import mirim.itshow.kiru.service.UserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter { //설정파일로 사용하기 위해 상속 받아야함
    private final UserService userService; //유저 정보가 있는 클래스 (생성 예정)
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(userService) //유저 정보 지정
